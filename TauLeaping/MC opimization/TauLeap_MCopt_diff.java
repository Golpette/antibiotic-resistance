...
public class TauLeap_MCopt_diff{


    // ################## PARAMETERS ####################

    static final int num_optimisations = 1;

    static final int nwells = 24;  

    static final double timestep = 0.001 ;  // fix these 2 values for 4 days = 96 hours
    static final int numsteps = 276000 ;
    ...
    //static final double bpMutation = 0;
    static final double marRfact = 00;
    ...
    public static double getDist_timePoint(double[] simulation, Double[] experiment){
        //method to compare 2 sets of well densities at a given point in time
        double dist = 0;
    ...
    public static void main(String args[])throws IOException{
        ...
        //    System.out.print( EXP_DATA.get("0.301")[i] + " "  );
        //}
        //System.exit(0);
	...
	for( int exp=0; exp<num_optimisations; exp++ ){
	    ...
	    wells[0].abundances.put("00000", K/2);
        ...
        // TODO: augment parameters
        //   FIRST DO NOT- SEE RANGE OF DISTANCES ARISING FROM FIXED PARAMETER SET
...
**/
        ...
        if( cum_dist < BEST_DIST )  {  BEST_DIST = cum_dist ; }
