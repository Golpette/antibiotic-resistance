...
ax2 = ax1.twinx()
ax1.set_xlabel('Well', fontsize=26);  
ax1.set_ylabel('Well population', fontsize=26)
ax2.set_ylabel('Antibiotic (ng/ml)', fontsize=26)
ax1.tick_params(axis='both', which='major', labelsize=20)
ax2.tick_params(axis='both', which='major', labelsize=20)


ax2.set_yscale('log')      # Uncomment if you don't want antibiotic concentration on log scale
...
for line in f:
    ...
    if (line_num % time_gap == 0 ):
        ...
        ax1.plot( wells, populations, linewidth='4', label=lbl )
...
############ ADD ANTIBIOTIC PROFILE TO FISHER WAVE PLOT ######################
...
ax2.plot(wl, anti, 'b--', linewidth='1')  
ax2.plot(wl, mic, 'b--', linewidth='1')
